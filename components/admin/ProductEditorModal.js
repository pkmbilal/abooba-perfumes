      ...
      ? createPortal(
          <div className="fixed inset-0 z-[70] flex items-center justify-center p-3 sm:p-6">
            <button
              ...
              className="absolute inset-0 bg-stone-950/45 backdrop-blur-xl"
            />

            <div className="relative z-10 mx-auto flex h-[calc(100vh-1.5rem)] w-full max-w-7xl flex-col overflow-hidden rounded-[2rem] border border-stone-200 bg-white shadow-[0_36px_120px_-48px_rgba(15,118,110,0.3)] dark:border-white/10 dark:bg-[#07131d] sm:h-[calc(100vh-3rem)]">
    ...
    <>
      ...
      {false ? (
        <div className="fixed inset-0 z-[70] flex items-center justify-center p-3 sm:p-6">
          ...
          <div className="relative z-10 mx-auto flex max-h-[92vh] w-full max-w-7xl flex-col overflow-hidden rounded-[2rem] border border-stone-200 bg-white shadow-[0_36px_120px_-48px_rgba(15,118,110,0.3)] dark:border-white/10 dark:bg-[#07131d]">
            <div className="flex items-start justify-between gap-4 border-b border-stone-200 bg-[radial-gradient(circle_at_top,_rgba(15,118,110,0.12),_transparent_55%),linear-gradient(180deg,_#fcfffe_0%,_#f8fafc_100%)] px-5 py-5 sm:px-7">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.3em] text-teal-700">
                  {isEditing ? "Edit product" : "Add product"}
